...
parser.add_argument(
    ...
    type=str,
    default='keys.log',
    help='The File on which Honeypot would be logging any key auth')
...
logfile1 = args.conn
logfile2 = args.auth
logfile3 = args.key_log

print(ip, port, logfile1, logfile2, logfile3)

ssh_run = ssht.sshtp(ip, port, logfile1, logfile2, logfile3)
ssh_run.run()
